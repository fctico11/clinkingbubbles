      ...
      <div className="bg-white text-black px-4 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          {[
            ...
            ["Sony GTK-XB60 Speakers", "Turn up the energy with our Sony GTK-XB60 speakers! These powerful, portable speakers deliver deep bass and vibrant sound, perfect for keeping the party going. With built-in lighting effects and Bluetooth connectivity, they're a must-have for any lively event."]
          ].map(([title, desc], i) => (

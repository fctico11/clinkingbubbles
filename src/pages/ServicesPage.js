      ...
      <div className="bg-[#EBE6D6] w-full pt-20 pb-8 px-4 mt-5">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            inclusions and an array of stylish add-ons to elevate your event to 
            pure luxury.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div className="space-y-6">
              ...
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                <p className="bubbles-font text-lg">
                  Shakers, stirrers, jiggers, muddlers, and more. Our expert bartenders 
                  come fully equipped so that every pour is as precise as it is delightful.
                </p>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="200">
                ...
                <p className="bubbles-font text-lg">
                  Keep beverages frosty and fresh all event long. We’ll supply 
                  enough ice tubs and coolers to handle your thirstiest crowd.
                </p>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="300">
                ...
                <p className="bubbles-font text-lg">
                  Napkins, straws, garnishes, and those little finishing touches 
                  that make each sip feel extra special—yes, we’ve got it all.
                </p>
              </div>
            ...
            <div className="space-y-6">
              <div data-aos="fade-up">
                ...
                <p className="bubbles-font text-lg">
                  From elegant signage to custom cocktail menus, we’ll handle the design details 
                  so you can show off your curated beverage lineup in style.
                </p>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="100">
                ...
                <p className="bubbles-font text-lg">
                  From classic citrus twists to artisanal floral elements, we ensure 
                  each cocktail looks as impressive as it tastes.
                </p>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="200">
                ...
                <p className="bubbles-font text-lg">
                  House-made simple syrups, premium juices, and an array of specialty 
                  mixers—consider your drink repertoire upgraded.
                </p>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="300">
                ...
                <p className="bubbles-font text-lg">
                  Disposable cups come standard; however, if you’d like to level up to 
                  real glassware or a unique theme, we can arrange an upgrade.
                </p>
              </div>
              ...
              <div data-aos="fade-up" data-aos-delay="400">
                ...
                <p className="bubbles-font text-lg">
                  No need to run last-minute ice errands! We’ll ensure you’re fully stocked 
